...
public class TrainCarriageService {
    ...
    public void save(TrainCarriageSaveReq req) {
        ...
        if (ObjectUtil.isNull(trainCarriage.getId())) {
            TrainCarriage selectByUnique = selectByUnique(req.getTrainCode(),req.getIndex());
            if (ObjectUtil.isNotEmpty(selectByUnique)){
                throw new BusinessException(BusinessExceptionEnum.BUSINESS_TRAIN_CARRIAGE_NAME_UNIQUE);
            }
